            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="avatar-group">
                        ...
                        <div class="avatar pull-up">
                            <img src="{{asset('images/portrait/small/avatar-s-10.jpg')}}" alt="Avatar" height="32" width="32" />
                        </div>
                        <div class="avatar pull-up">
                            <img src="{{asset('images/portrait/small/avatar-s-8.jpg')}}" alt="Avatar" height="32" width="32" />
                        </div>
                        <div class="avatar pull-up">
                            <img src="{{asset('images/portrait/small/avatar-s-20.jpg')}}" alt="Avatar" height="32" width="32" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="avatar-group">
                        ...
                        <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Elicia Rieske" class="avatar pull-up">
                            <img src="{{asset('images/portrait/small/avatar-s-7.jpg')}}" alt="Avatar" height="32" width="32" />
                        </div>
                        ...
                        <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Jenny Looper" class="avatar pull-up">
                            <img src="{{asset('images/portrait/small/avatar-s-20.jpg')}}" alt="Avatar" height="32" width="32" />
                        </div>
                    </div>
                </div>
